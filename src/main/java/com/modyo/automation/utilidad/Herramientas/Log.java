...
public class Log {
    ...
    // Dentro de la data que se debe envia, debemos informar el usuario, la fecha, el caso de prueba ejecutado
    ...
    public void AgregarLoguerDia(String data, String carpeta){
        try {
            ...
            FechaHoraActual fech = new FechaHoraActual();
            ...
            bw.write("" + "\n" + fech.getFecha() + " " + fech.getHora() + " : " + data);
