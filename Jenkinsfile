  ...
  stages {
    stage('Build') {
      ...
      steps {
        ...
        echo 'Fin Build'
        slackSend(token: '8xVDBA48XlCFjCrG9lCyLmbj', teamDomain: 'enmilocalfuncionaco', channel: 'test', color: 'yellow', attachments: 'Se inicia Deploy Utilidades', baseUrl: 'https://enmilocalfuncionaco.slack.com', message: 'test', username: 'jenkins')
      }
    }
